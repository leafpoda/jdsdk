<?php
class AdsIbgUniversalJosServiceIndustryKeywordTrendRequest
{
	...
	public function getApiMethodName(){
	  return "jingdong.ads.ibg.UniversalJosService.industry.keyword.trend";
	}
	...
	public function setWordType($wordType){
		$this->wordType = $wordType;
         $this->apiParas["wordType"] = $wordType;
	}
