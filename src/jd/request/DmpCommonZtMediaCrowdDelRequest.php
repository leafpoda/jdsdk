<?php
class DmpCommonZtMediaCrowdDelRequest
{
	...
	public function getApiMethodName(){
	  return "jingdong.dmp.common.zt.media.crowd.del";
	}
	...
	public function getAuthType(){
	  return $this->authType;
                        	                        	                        	                        	                        	                        	                   			...
                        	                        	                        	                        	                        	                        	                   			private $deletedMediaCrowdIdsList;
    	                        
	public function setDeletedMediaCrowdIdsList($deletedMediaCrowdIdsList){
		$this->deletedMediaCrowdIdsList = $deletedMediaCrowdIdsList;
         $this->apiParas["deletedMediaCrowdIdsList"] = $deletedMediaCrowdIdsList;
	}

	public function getDeletedMediaCrowdIdsList(){
	  return $this->deletedMediaCrowdIdsList;
	}
