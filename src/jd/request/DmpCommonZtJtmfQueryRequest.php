<?php
class DmpCommonZtJtmfQueryRequest
{
	...
	public function getApiMethodName(){
	  return "jingdong.dmp.common.zt.jtmf.query";
	}
	...
	public function getProfileType(){
	  return $this->profileType;
                        	                        	                   			...
                        	                        	                   			private $jtmfRequestVO;
    	                        
	public function setJtmfRequestVO($jtmfRequestVO){
		$this->jtmfRequestVO = $jtmfRequestVO;
         $this->apiParas["jtmfRequestVO"] = $jtmfRequestVO;
	}

	public function getJtmfRequestVO(){
	  return $this->jtmfRequestVO;
	}
