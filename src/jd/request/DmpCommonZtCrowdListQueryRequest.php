<?php
class DmpCommonZtCrowdListQueryRequest
{
	...
	public function getApiMethodName(){
	  return "jingdong.dmp.common.zt.crowd.list.query";
	}
	...
	public function getProfileType(){
	  return $this->profileType;
                        	                        	                   			...
                        	                        	                   			private $mediaCrowdQuery;
    	                        
	public function setMediaCrowdQuery($mediaCrowdQuery){
		$this->mediaCrowdQuery = $mediaCrowdQuery;
         $this->apiParas["mediaCrowdQuery"] = $mediaCrowdQuery;
	}

	public function getMediaCrowdQuery(){
	  return $this->mediaCrowdQuery;
	}
