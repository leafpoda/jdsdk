<?php
class AdsIbgUniversalJosServiceIndustryIndustrySearchWordRequest
{
	...
	public function getApiMethodName(){
	  return "jingdong.ads.ibg.UniversalJosService.industry.industry.searchWord";
	}
	...
	public function getCid3(){
	  return $this->cid3;
                        	                   			...
                        	                   			private $searchWordBoardType;
    	                        
	public function setSearchWordBoardType($searchWordBoardType){
		$this->searchWordBoardType = $searchWordBoardType;
         $this->apiParas["searchWordBoardType"] = $searchWordBoardType;
	}

	public function getSearchWordBoardType(){
	  return $this->searchWordBoardType;
	}

                        	                   			private $searchWordType;
    	                        
	public function setSearchWordType($searchWordType){
		$this->searchWordType = $searchWordType;
         $this->apiParas["searchWordType"] = $searchWordType;
	}

	public function getSearchWordType(){
