<?php
class DmpCommonZtMediaCrowdEstimateRequest
{
	...
	public function getApiMethodName(){
	  return "jingdong.dmp.common.zt.media.crowd.estimate";
	}
	...
	public function getJdMediaUserId(){
	  return $this->jdMediaUserId;
                        	                   			...
                        	                   			private $mediaGroupInfo;
    	                        
	public function setMediaGroupInfo($mediaGroupInfo){
		$this->mediaGroupInfo = $mediaGroupInfo;
         $this->apiParas["mediaGroupInfo"] = $mediaGroupInfo;
	}

	public function getMediaGroupInfo(){
